...
public class VerbindungStyleConfiguration implements StyleConfiguration {
	
	public VerbindungStyleConfiguration() {
	...
	public Image getLabelIcon(DDiagramElement arg0, IGraphicalEditPart arg1) {
		System.out.println("getLabelIcon");
		return DEFAULT.getLabelIcon(arg0, arg1);
	}
